...
namespace BarcodeLib
{
    ...
    public class Barcode: IDisposable
    {
        ...
        public void Encode(TYPE iType, string StringToEncode, int Width, int Height)
        {
            this.Width = Width;
            this.Height = Height;
             Encode(iType, StringToEncode);
        ...
        /// <param name="Height">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public void Encode(TYPE iType, string StringToEncode, Color ForeColor, Color BackColor, int Width, int Height)
        {
            this.Width = Width;
            this.Height = Height;
             Encode(iType, StringToEncode, ForeColor, BackColor);
        ...
        /// <param name="BackColor">Background color</param>
        /// <returns>Image representing the barcode.</returns>
        public void Encode(TYPE iType, string StringToEncode, Color ForeColor, Color BackColor)
        {
        ...
        /// <param name="StringToEncode">Raw data to encode.</param>
        /// <returns>Image representing the barcode.</returns>
        public void Encode(TYPE iType, string StringToEncode)
        {
        ...
        /// </summary>
        /// <param name="iType">Type of encoding to use.</param>
        internal void Encode(TYPE iType)
        {
            Encoded_Type = iType;
             Encode();
        }//Encode()
                                ...
                                using (Pen pen = new Pen(ForeColor, iBarWidth / iBarWidthModifier))
                                {
                                    while (pos < Encoded_Value.Length)
                                    {
                                        if (this.Encoded_Type == TYPE.PostNet)
                                        {
                                            ...
                                            if (Encoded_Value[pos] != '1')
                                                g.DrawLine(pen, new Point(p_Width+ pos * iBarWidth + shiftAdjustment + 1,p_Height+ Height), new Point(p_Width+ pos * iBarWidth + shiftAdjustment + 1,p_Height+ Height / 2));
                                            
                                            //draw spaces between bars in postnet
                                            g.DrawLine(backpen, new Point(p_Width+ pos * (iBarWidth * iBarWidthModifier) + shiftAdjustment + iBarWidth + 1, p_Height), new Point(p_Width+ pos * (iBarWidth * iBarWidthModifier) + shiftAdjustment + iBarWidth + 1,p_Height+ Height));
                                        }//if

                                        if (Encoded_Value[pos] == '1')
                                            g.DrawLine(pen, new Point(p_Width+ pos * iBarWidth + shiftAdjustment + (int)(iBarWidth * 0.5),p_Height), new Point(p_Width+ pos * iBarWidth + shiftAdjustment + (int)(iBarWidth * 0.5),p_Height+ Height));
        ...
        private void Label_Generic()
        {
            try
            {
                ...
                
                {
                    ...
                    g.FillRectangle(new SolidBrush(this.BackColor), new RectangleF((float)p_Width, (float)p_Height+ LabelY, (float)Width, (float)font.Height+1));

                    //draw datastring under the barcode image
                    g.DrawString(this.RawData, font, new SolidBrush(this.ForeColor), new RectangleF((float)p_Width, (float)p_Height+ LabelY, (float)Width, (float)font.Height), f);
        ...
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g, TYPE iType, string Data)
        {
        ...
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g,TYPE iType, string Data, ref string XML)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
        ...
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g,TYPE iType, string Data, bool IncludeLabel)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
        ...
        public static void DoEncode(Graphics g, TYPE iType, string Data, bool IncludeLabel,int width,int height)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
        ...
        /// <param name="Height">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g,int p_width,int p_height,TYPE iType, string Data, bool IncludeLabel, int Width, int Height)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
        ...
        /// <param name="BackColor">Background color</param>
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g,TYPE iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
        ...
        /// <param name="Height">Height of the resulting barcode.(pixels)</param>
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g,TYPE iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor, int Width, int Height)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
        ...
        /// <param name="XML">XML representation of the data and the image of the barcode.</param>
        /// <returns>Image representing the barcode.</returns>
        public static void DoEncode(Graphics g,TYPE iType, string Data, bool IncludeLabel, Color DrawColor, Color BackColor, int Width, int Height, ref string XML)
        {
            using (Barcode b = new Barcode())
            {
                b.g = g;
